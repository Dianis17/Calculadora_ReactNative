    ...
    return (
        <View style={styles.calculatorContainer}>
            ...
            <View style={styles.row}>
                ...
                <CalculatorButton onPress={deleOperation} blackText label="Del" color={colors.lightGray}/>
            ...
            <View style={styles.row}>
                ...
                <CalculatorButton onPress={multuplyOperation} label="x" color={colors.orange}/>
            </View>
